...
export default function TabelaTelefones(props){
    ...
    return (
        <Container className="m-3 border">
            <Table striped bordered hover variant="dark">
                <thead>
                    <tr>
                        <th className="text-center">Código do teoelfone</th>
                ...
                <tbody>
                    {
                        props.listaTelefones?.map((item, indice)=>{
                            return <tr key={indice}>
                                ...
                                <td className="text-center">
                                    <Button onClick={()=>{
                                        ...
                                        props.setTelefone({...props.dados, telefones:lista});
                                        props.setListaTelefones(lista);
                                    }}>
